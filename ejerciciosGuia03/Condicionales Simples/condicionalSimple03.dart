...
void main(List<String> args) {
  ...
  */
  ...
  print(
      "La cantidad de trajes que usted comprara del modelo: $modeloTraje sera: $cantidadTrajes, el precio de el traje es de: $precioUnitario y su compra caldra en: $precioFinal");
}
